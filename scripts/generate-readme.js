 ...
 * @returns {string}
 */
const makePrompt = (code) => `I have a set of jscodeshift codemods designed to replace inefficient or unnecessary npm modules with alternative packages or built-in ES features. Your task is to write a markdown description for each of these codemods. The markdown should follow this format:
...
if (!arg) {
	console.error("Please provide a codemod name or --all");
	process.exit(1);
} else if (arg === "--all") {
